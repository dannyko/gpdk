...
(function() {
  ...
  this.Spacepong = (function(_super) {
    ...
    Spacepong.ball_count = function() {
      ...
      if ((1000 <= (_ref = Game.score) && _ref < 5000)) {
        count = 2;
      }
      if ((5000 <= (_ref1 = Game.score) && _ref1 < 10000)) {
        count = 3;
      }
      if ((10000 <= (_ref2 = Game.score) && _ref2 < 20000)) {
        count = 4;
      }
      if (Game >= 20000) {
        count = 5;
    ...
    Spacepong.prototype.spawn_ships = function() {
      var index, ship;
      this.new_ship_count = Math.max(1, this.initialN + Math.floor(Game.score / 1000));
