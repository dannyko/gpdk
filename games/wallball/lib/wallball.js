...
(function() {
  ...
  this.Ball = (function(_super) {
    ...
    function Ball(config) {
      ...
      this.speed = this.initial_speed + Game.score * this.speed_factor;
      this.max_speed = 200;
      this.image.remove();
    ...
    Ball.prototype.draw = function() {
      var min_y;
      this.speed = Math.min(this.max_speed, this.initial_speed + Game.score * this.speed_factor);
  ...
  this.Wallball = (function(_super) {
    ...
    Wallball.prototype.text = function() {
      ...
      if (!(Game.lives < 0)) {
        return this.lives.text('LIVES: ' + Game.lives);
      }
    };
    ...
    Wallball.prototype.start = function() {
      ...
      title.text("WALLBALL");
      go = this.g.append("text").text("").attr("stroke", "none").attr("fill", "#FF4").attr("font-size", "36").attr("x", Game.width * 0.5 - 60).attr("y", Game.height / 2 + 130).attr('font-family', 'arial').attr('font-weight', 'bold').style("cursor", "pointer").text("START");
