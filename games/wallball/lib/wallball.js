...
(function() {
  ...
  this.Paddle = (function(_super) {
    ...
    function Paddle(config) {
      ...
      this.r.y = Game.height - this.height;
    ...
    Paddle.prototype.stop = function() {
      ...
      return d3.select(window.top).on("mousemove", null);
    };

    Paddle.prototype.destroy_check = function(n) {
      var intersect_x, relative_intersect, x_spd;
      if (n.type !== 'Circle') {
        console.log(n);
      }
      intersect_x = n.r.x - this.r.x;
      relative_intersect = intersect_x / this.size;
      if (relative_intersect < -1) {
      ...
      if (relative_intersect === 0) {
        relative_intersect = 0.01;
      }
      n.v.x = relative_intersect * n.speed;
      n.v.y = -Math.sqrt(n.speed * n.speed - n.v.x * n.v.x);
      if (Math.abs(n.v.y) < this.min_y_speed) {
        n.v.y = -this.min_y_speed;
        x_spd = Math.sqrt(n.speed * n.speed - this.min_y_speed * this.min_y_speed);
        if (relative_intersect > 0) {
          n.v.x = x_spd;
        }
        if (relative_intersect < 0) {
  ...
  this.Wallball = (function(_super) {
    ...
    Wallball.prototype.level = function() {
      var dur, ready,
        _this = this;
      this.new_ball_needed = false;
      this.ball = null;
    ...
    Wallball.prototype.progress = function() {
      ...
      if ((_ref = this.ball) != null ? _ref.is_destroyed : void 0) {
        this.new_ball_needed = true;
      }
      if (this.new_ball_needed) {
        this.level();
      }
      on_edge = false;
      if (this.ball != null) {
