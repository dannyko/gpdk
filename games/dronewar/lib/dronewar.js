...
(function() {
  ...
  this.Game = (function() {
    ...
    function Game(config) {
      ...
      this.preload_images(this.init);
    }

    Game.prototype.preload_images = function(final_callback) {
      var callback;
  ...
  this.Drone = (function(_super) {
    ...
    Drone.prototype.set_param = function() {
      ...
      this.param.q = this.root.charge * (1 + Game.score / 1000);
    ...
    Drone.prototype.remove = function(effects) {
      ...
      dur = 800;
      if (effects) {
        this.overlay.attr("r", this.size * .9).attr("x", 0).attr("y", 0).style('fill', '#800').style('opacity', .7).transition().duration(dur).attr('transform', 'scale(5)').ease('linear').each('end', (function(_this) {
          return function() {
  ...
  this.Dronewar = (function(_super) {
    ...
    Dronewar.prototype.text = function() {
      ...
      return this.lives.text('ENERGY: ' + Game.lives);
    };
