class $z.Ship # designed for Gameprez by Thomas Birdsey, http://twitter.com/Tbirdsey
  @viper: -> {path: [
          ...
          ], url: GameAssetsUrl + "viper_1.png", offset: {x: 0, y: 19}, bullet_stroke: 'none', bullet_fill: '#90F ', bullet_size: 4, bullet_speed: 6, bullet_tick: 70}
  ...
  @fang: -> {path: [
          ...
          ], url: GameAssetsUrl + "fang_1.png", offset: {x: 0, y: 25}, bullet_stroke: 'none', bullet_fill: '#C00', bullet_size: 5, bullet_speed: 5, bullet_tick: 80}
  ...
  @cobra: -> {path: [{pathSegTypeAsLetter: 'M', x:  8,  y: -26, react: true},  
                        ...
                        {pathSegTypeAsLetter: 'L', x:  8,  y: -14, react: true},
                        {pathSegTypeAsLetter: 'Z'}
		   	        ], url: GameAssetsUrl + "cobra_1.png", offset: {x: 0, y: 0}, bullet_stroke: 'none', bullet_fill: '#d3bc5f', bullet_size: 4.5, bullet_speed: 5.5, bullet_tick: 90}