class @Ship # hand-drawn polygons paths designed by Thomas Birdsey and Daniel Korenblum
  # @viper = [{pathSegTypeAsLetter: 'M', x: 0,  y: -20, react: true},     {pathSegTypeAsLetter: 'L', x: 8,  y: -1, react: true},     {pathSegTypeAsLetter: 'L', x: 3,  y: 6, react: true}, {pathSegTypeAsLetter: 'L', x: 1,  y: 3, react: true},  {pathSegTypeAsLetter: 'L', x: -1,  y: 3, react: true},           {pathSegTypeAsLetter: 'L', x: -3,  y: 6, react: true},           {pathSegTypeAsLetter: 'L', x: -8,  y: -1, react: true},			{pathSegTypeAsLetter: 'Z'}  ]
  @viper = [
  ...
  @sidewinder = [{pathSegTypeAsLetter: 'M', x: 8,  y: -26, react: true},  
