class @Ship # designed for Gameprez by Thomas Birdsey, http://twitter.com/Tbirdsey
  @viper: -> {path: [
          ...
          ], url: GameAssetsUrl + "viper_1.png", offset: {x: 0, y: 19}, bullet_stroke: 'none', bullet_fill: '#90F ', bullet_size: 4, bullet_speed: 5, bullet_tick: 60}
  ...
  @fang: -> {path: [
          ...
          ], url: GameAssetsUrl + "fang_1.png", offset: {x: 0, y: 25}, bullet_stroke: 'none', bullet_fill: '#C00', bullet_size: 6, bullet_speed: 4, bullet_tick: 90}
